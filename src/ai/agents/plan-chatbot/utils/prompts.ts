...
- **UNSUPPORTED OPERATIONS**: "add [day] to the plan", "add [day] as a day to the plan", "add a new day", "create a new day" — these are NOT supported. The system does not support adding new days to the plan structure. Do NOT classify these as add_task or add_days_off.
