...
/**
 * Process add_days_off operation
 */
export async function processAddDaysOff(
  userId: string,
  extractedEdit: EditAnalysisResult["extractedEdit"],
): Promise<
  | {
      shouldConfirm: true;
      pendingEdit: {
...
/**
 * Process remove_days operation
 */
export async function processRemoveDays(
  userId: string,
  extractedEdit: EditAnalysisResult["extractedEdit"],
): Promise<
  | {
...
/**
 * Process copy_day operation
 */
export async function processCopyDay(
  userId: string,
  extractedEdit: EditAnalysisResult["extractedEdit"],
): Promise<
  | {
...
/**
 * Process rename_day operation
 */
export async function processRenameDay(
  userId: string,
  extractedEdit: EditAnalysisResult["extractedEdit"],
): Promise<
  | {
...
/**
 * Process swap_days operation
 */
export async function processSwapDays(
  userId: string,
  extractedEdit: EditAnalysisResult["extractedEdit"],
): Promise<
  | {
...
> {
  ...
  switch (editType) {
    case "add_days_off":
      return await processAddDaysOff(userId, extractedEdit);

    case "remove_days":
      return await processRemoveDays(userId, extractedEdit);

    case "copy_day":
      return await processCopyDay(userId, extractedEdit);

    case "rename_day":
      return await processRenameDay(userId, extractedEdit);
